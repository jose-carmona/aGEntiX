...
def get_required_permission(tool_name: str) -> Optional[str]:
    ...
    Returns:
        Permiso requerido o None si no requiere permiso específico

    Permisos disponibles:
        - "consulta": Lectura de expedientes
        - "gestion": Escritura de expedientes
        - "documentacion:leer": Lectura de documentación de tipos de expediente
        - "documentacion:buscar": Búsqueda en documentación
    """
    # Tools de solo lectura de expedientes: requieren "consulta"
    read_tools = [
    ...
    # Tools de escritura de expedientes: requieren "gestion"
    write_tools = [
        "añadir_documento",
        "actualizar_datos",
        "añadir_anotacion"
    ...
    # Tools de lectura de documentación: requieren "documentacion:leer"
    doc_read_tools = [
        "listar_documentacion",
        "obtener_doc_documentacion"
    ]

    # Tools de búsqueda en documentación: requieren "documentacion:buscar"
    doc_search_tools = [
    ...
    if tool_name in read_tools:
        ...
        return "gestion"
    elif tool_name in doc_read_tools:
        return "documentacion:leer"
    elif tool_name in doc_search_tools:
        return "documentacion:buscar"
